...
import org.camilo.apiservlet.webapp.headers.services.ProductoServiceJdbcImpl;
...
public class ProductoFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("title", req.getAttribute("title") + ": Formulario producto");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (sku == null || sku.isBlank()){
            errores.put("sku", "el codigo es requerido!");
        } else if (sku.length() > 10){
            errores.put("sku", "el codigo debe tener max 10 caracteres!");
        }
